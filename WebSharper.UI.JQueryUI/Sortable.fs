...
type Sortable [<JavaScript>] internal () =
    ...
    *****************************************************************)
    ...
    member this.OnSort f =
        this.OnAfterRender(fun _ -> this.onSort f) |> ignore
    ...
    member this.OnBeforeStop f =
        this.OnAfterRender(fun _ -> this.onBeforeStop f) |> ignore
